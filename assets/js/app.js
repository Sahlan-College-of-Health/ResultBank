    ...
    button.addEventListener("click", () => {
      ...
      area.innerHTML = rows.length ? `
        <div class="result-toolbar no-print">
          ...
          <button id="securePrintYear" class="primary-btn">Print Year ${year}</button>
        </div>
      ...
      document
        .getElementById("securePrintYear")
        ?.addEventListener("click", () => printResultDocument("session"));
    });
  });
  ...
  document.getElementById("secureTranscriptBtn").addEventListener("click", () => {
    ...
    area.innerHTML = `
      <div class="result-toolbar no-print">
        ...
        <button id="securePrintTranscript" class="primary-btn">Print Transcript</button>
      </div>
      <article class="official-result">
        ${officialResultHeader("COMPLETE ACADEMIC TRANSCRIPT")}
        ${studentIdentitySection(student)}
    ...
    document
      .getElementById("securePrintTranscript")
      .addEventListener("click", () => printResultDocument("transcript"));
  });
  ...
  dashboardLayout(`
    ...
    <section class="card">
      <div class="import-note">
        Passwords are generated once and downloaded as a CSV file. Keep the file securely and
        distribute each password only to the matching student. Passwords are not stored in Firestore.
      </div>
